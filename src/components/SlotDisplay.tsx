...
export function SlotDisplay({ slots, scheme, locale, t }: Props) {
  return (
    <div className="flex gap-4" aria-label={t('app.title')}>
      <Slot index={0} spell={slots[0]} scheme={scheme} locale={locale} t={t} />
      <Slot index={1} spell={slots[1]} scheme={scheme} locale={locale} t={t} />
    </div>
  )
}
