...
const UI_ZH: Dict = {
  ...
  'help.practice.sound': '释放技能 / 祈唤成功时播放对应音效;底部 🔊 按钮可一键静音,设置持久化。',
...
const UI_EN: Dict = {
  ...
  'help.practice.sound': 'Casting a spell / a successful invoke plays the matching sound effect; the 🔊 button at the bottom mutes all sounds, persisted in settings.',
