...
const UI_ZH: Dict = {
  ...
  'combo.new': '新建连招',
  'combo.name': '连招名称',
  'combo.namePlaceholder': '不填则自动按技能名生成',
...
const UI_EN: Dict = {
  ...
  'combo.namePlaceholder': 'Leave empty to auto-generate from spell names',
  ...
  'combo.edit': 'Edit',
  'combo.delete': 'Delete',
  'combo.deleteConfirm': 'Delete this combo?',
