...
const UI_ZH: Dict = {
  ...
  'help.practice.recipe': '自由练习页标题旁的 👁 眼睛按钮可切换显示"技能配方"参考面板(10 个技能及其 3 元素配方,元素用图标),方便不熟悉技能的用户随时查阅。',
...
const UI_EN: Dict = {
  ...
  'help.practice.recipe': 'The 👁 eye button next to the free-practice title toggles a "Spell Recipes" reference panel (all 10 spells with their 3-element recipes, elements shown as icons) for quick lookup by users unfamiliar with the spells.',
